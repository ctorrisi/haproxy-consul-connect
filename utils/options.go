...
// Defaults to HTTP mode for efficient connection pooling and HTTP/2 support (gRPC, REST APIs)
// Use protocol: "tcp" in Consul config for non-HTTP services (databases, custom protocols)
